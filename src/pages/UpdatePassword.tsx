...
export default function UpdatePassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Déconnecter après le changement pour forcer un nouveau login propre
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-100 flex items-center justify-center px-4">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <Link
              to="/adherent/reset-password"
              className="inline-block bg-gradient-to-r from-rose-500 to-pink-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-rose-600 hover:to-pink-700 transition-all"
            >
              Nouvelle demande
            </Link>
          </div>
